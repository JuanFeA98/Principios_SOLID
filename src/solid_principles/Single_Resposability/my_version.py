...
class PaymentProcessor:
    def process_transaction(self, customer_data, payment_data) -> Charge:
        ...
        if "email" in customer_data["contact_info"]:
            ...
            print(f"""
                send the sms using {sms_gateway}:
                SMS sent to {phone_number}: Thank you for your payment.
            """)
        ...
        with open("transactions.log", "a", encoding='utf-8') as log_file:
